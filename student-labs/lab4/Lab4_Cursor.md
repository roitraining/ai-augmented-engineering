...
hardest thing an agent does: decline to act. If you want to watch it prove that, open
`.cursor/debug-<id>.log` — the entries record the fixture answering, twenty records resolved, and
the run completing without an exception.
